...
In 1951 Ore conjectured that in each finite non-abelian simple group $G$ every element is a commutator. 
...
\begin{example}[Ore's conjecture for sporadic simple groups]
\index{Ore!conjecture}
\index{Theorem!of Liebeck--O'Brien--Shalev--Tiep}
